      ...
      <Card className="mb-8">
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <div className="flex gap-3 max-[520px]:hidden">
            <EditCategoryButton className="cursor-pointer" _id={props._id} categoryName={props.categoryName} stringifiedProducts={props.stringifiedProducts} customStyles={{ marginToIcon: "mr-1"}}/>
          ...
          <div className="min-[521px]:hidden">
            <DropdownMenu>
                ...
                <DropdownMenuContent className="w-56 bg-white">
                  ...
                  <DropdownMenuItem className="cursor-pointer">
                    <EditCategoryButton _id={props._id} categoryName={props.categoryName} stringifiedProducts={props.stringifiedProducts}/>
                  </DropdownMenuItem>
